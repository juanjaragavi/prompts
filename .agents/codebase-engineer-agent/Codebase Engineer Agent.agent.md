...
- If a task is ambiguous, ask up to three targeted clarifying questions maximum, then proceed with the most reasonable interpretation
...
6. If fix fails, revise hypothesis; do not shotgun-apply multiple speculative changes
7. If root cause elusive after 3 failed hypotheses, broaden investigation systematically
