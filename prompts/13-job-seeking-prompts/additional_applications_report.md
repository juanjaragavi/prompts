# Additional Job Applications Report

This report documents five (5) new, distinct job opportunities applied to on LinkedIn as part of finding roles similar to the Senior Web Project Manager & Marketing Strategist position.
...
- **Key Answers/Details:**
  ...
  - 15 years web agency experience.
  - 2+ years managing WordPress projects.
  - Completed WordPress kickoff-to-launch (25+ projects).
...
- **Status:** Submitted via Easy Apply
- **Key Answers/Details:**
  - Verified remote comfort.
  - Verified 8+ years marketing/SaaS project management experience.
...
- **Key Answers/Details:**
  ...
  - Entered 6 years of AWS experience.
  - Entered 10 years of Microsoft PowerPoint experience.
...
- **Key Answers/Details:**
  ...
  - Client-facing experience: 15 years.
  - Toolsets listed: Figma, WordPress, Webflow, Shopify, Framer, Asana, Monday.com, Jira, Vertex AI, BigQuery, Supabase, PostgreSQL, Docker, Git, Slack, Google Workspace, PM2, Vercel.
  - AI tools: Yes (expert OpenAI/Claude).
  - Automation scratch: Yes.
  - Experience details (International): Yes (US, UK, Mexico, Spain).
...
- **Key Answers/Details:**
  ...
  - IT or Business Systems PM: Yes (2+ years in SaaS/Healthcare/tech).
  - Agile, Jira, Asana, Microsoft Project: Yes.
  - Salesforce/NetSuite CRM/ERP: Yes.
  - Salary expectations: 15,000,000 COP monthly (entered as numeric decimal).
