...
Ground every FDE application in these verified proof points from his CV:

- **Client-embedded production delivery:** As AI Development Lead at TopNetworks Inc.
  (Feb 2025 – Jun 2026), he led AI strategy, architecture, and full-stack development for
  performance-publishing platforms serving the U.S., U.K., Mexico, and Latin America — shipping
  against live production traffic and partner integrations.
- **Custom APIs, ETL pipelines, and RAG/agent workflows:** He designed and built the internal
...
- **Technical stakeholder alignment:** 17+ years of consulting and agency leadership (Co-founder
  / Director of Innovation at TRADEBOG S.A.S.; Co-founder / Operations Director at FreshWorks;
  Project Director at 2W Agencia Digital; Co-founder / Project Manager at La Quinta P Digital
  Agency) — a direct match for articulating trade-offs to client executives and engineering leads.
