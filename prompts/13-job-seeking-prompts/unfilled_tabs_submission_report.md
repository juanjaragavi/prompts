# Unfilled Tabs Job Submission Report

This report summarizes the processing and submission status of the job applications extracted from the open browser tabs. Out of the 8 identified applications, 6 were successfully submitted, 1 was blocked by security mechanisms (CAPTCHA), and 1 failed due to strict eligibility constraints.

## Application Status Summary

| Company              | Role                                            | Platform        | Status          | Screenshot Reference                       |
| :------------------- | :---------------------------------------------- | :-------------- | :-------------- | :----------------------------------------- |
| **Medfar**           | Generative AI (GenAI) \| Prompt Engineer        | SmartRecruiters | CAPTCHA Blocked | `screenshots/application_1_screenshot.png` |
| **TherapyNotes.com** | Senior Software Developer (Agentic Development) | Workable        | Submitted       | `screenshots/application_2_screenshot.png` |
| **Xsolla**           | Product Owner, DevX and AI — Shop Builder       | Lever           | Submitted       | `screenshots/application_3_screenshot.png` |
| **Bjak**             | Applied AI Engineer                             | Ashby           | Submitted       | `screenshots/application_4_screenshot.png` |
| **Team Red Dog**     | AI Prompt Engineer                              | Crelate         | Submitted       | `screenshots/application_5_screenshot.png` |
| **Curve Dental**     | AI/ML Platform Software Developer               | Rippling        | Failed          | `screenshots/application_6_screenshot.png` |
| **Netomi**           | Agentic Engineer                                | Lever           | Submitted       | `screenshots/application_7_screenshot.png` |
| **WorkBetterNow**    | AI Software Developer (Internal Tools)          | Zoho Recruit    | Submitted       | `screenshots/application_8_screenshot.png` |

---

## Detailed Notes on Failed or CAPTCHA Blocked Applications

### 1. Medfar — Generative AI (GenAI) | Prompt Engineer
...
- **Required Human Action:**
  A manual intervention is required to access the page, solve the CAPTCHA challenge, and complete the submission manually using the `Juan_Jaramillo_Resume_AI_LLM.pdf` resume.

### 2. Curve Dental — AI/ML Platform Software Developer
...
- **Required Human Action:**
  The candidate should review if there is an alternative contact path or if they can bypass the strict residency questionnaire if remote arrangements are possible. If remote work is not supported, this application cannot proceed.

---

## Detailed Notes on Submitted Applications

### 3. TherapyNotes.com — Senior Software Developer (Agentic Development)
...
### 4. Xsolla — Product Owner, DevX and AI — Shop Builder
...
### 6. Team Red Dog — AI Prompt Engineer
...
### 8. WorkBetterNow — AI Software Developer (Internal Tools)
...
- **Uploaded Files:**
  ...
  - `EFSET_Certificate.pdf` (EFSET Certificate)
  - `System_Specs_Screenshot.png` (Specs Screenshot)
- **Details:** Custom form completed by inputting contact details, DOB, phone policy consent, and experience essay, and uploading all required custom documents. Submitted successfully on Zoho Recruit.
