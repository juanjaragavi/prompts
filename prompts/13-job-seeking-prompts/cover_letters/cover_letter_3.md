...
**A la atención del Equipo de Selección de Inteligencia Artificial**  
**Puesto: Programador/a con enfoque Vibe Coding (IA) (Barcelona, Presencial)**
...
- **Dominio Técnico de Frameworks Modernos:** Trabajo fluidamente en todo el stack web: **HTML, CSS (incluyendo Tailwind CSS v4), JavaScript/TypeScript, React 19.2 y Next.js 16 (App Router)**. En mi rol reciente como **AI Development Lead en TopNetworks Inc.**, diseñé e implementé un ecosistema SaaS completo (incluyendo _Social Media Genius_, un editor de contenido social con un canvas interactivo, y _EmailGenius_, un generador de correos con Vertex AI).
