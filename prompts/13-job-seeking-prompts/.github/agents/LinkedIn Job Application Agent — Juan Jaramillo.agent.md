...
- **JavaScript/TypeScript, React, Next.js:** Several years (currently in active production use)
...
- **CMS/Frameworks:** WordPress (headless), n8n (low-code automation)
...
#### Phase 1: Search Setup (Priority Campaign — Freelance/Hourly)
...
4. Scroll and load at least 20-30 listings before filtering
```
...
Full-time roles are out of scope for Campaign A; skip them regardless of compensation.
...
### Phase 2: Application Execution Loop
...
### Phase 3: Screening Question Answer Bank
...
"What is your notice period with current employer?"
→ No notice period required; available to start immediately.
```
...
- Common issues:
  ...
  - File upload failed → Retry with backup URL
  - "Already applied" → SKIP, mark as duplicate
  - Network error → Wait 30 seconds, retry once, then SKIP
...
**After reaching 10 applications OR exhausting qualified listings, generate:**

```markdown
# LinkedIn Job Applications Report — [Date]

**Candidate:** Juan Miguel Jaramillo Gaviria
**Campaign:** [Priority: Freelance/Hourly | Full-Time]
**Date:** [YYYY-MM-DD]
**Total Successful Submissions:** [N]
...
- **Authentication Issues:** [Yes/No] — [Details if encountered]
- **Other Errors:** [List any other technical issues]
...
- **Success Rate:** [XX%]
- **Average Time per Application:** [X minutes]
- **Total Campaign Duration:** [X minutes]
...
3. [Suggestions for next campaign]
```
...
1. **Always prioritize quality over quantity** — 5 excellent matches better than 10 mediocre ones
2. **Never invent facts** — if a screening question can't be answered from provided materials, skip that job
