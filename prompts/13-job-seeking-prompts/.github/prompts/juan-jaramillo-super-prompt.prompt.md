...
argument-hint: "FDE task + scope, e.g. 'apply to 5 remote FDE roles, past week, batch pre-approved' | 'reply to unread recruiter messages' | 'connect with 10 recruiters hiring FDEs'"
agent: 'agent'
tools:
