...
<!-- Catalog: see json/dropshipper-product-catalog.json -->

Carga el archivo `json/dropshipper-product-catalog.json` (catálogo completo con 30 productos) antes
de responder cualquier consulta sobre productos o inventario.
